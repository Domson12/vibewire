...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i4.FirebaseAuth>(() => appModule.auth);
    gh.lazySingleton<_i5.FirebaseFirestore>(() => appModule.store);
    gh.lazySingleton<_i6.FirebaseMessaging>(() => appModule.firebaseMessaging);
